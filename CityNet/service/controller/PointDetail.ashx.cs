...
namespace CityNet.service.controller
{
    ...
    /// PointDetail 的摘要说明
    /// </summary>
    public class PointDetail : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            String json = "{success:0,url:'',params:'',message:'后台程序出错',pointid:0}";
            if (vec.Count >= 3 && pointid != null)
            {
                ...
                if (dt != null)
                {
                    ...
                    json = "{success:1,url:'" + url + "',params:'" + param + "',message:'" + message + "',pointid:'" + pointid + "'}";
                }
            }
