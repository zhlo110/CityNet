/*
This file is part of Ext JS 5.1.4.338
...
Version: 5.1.4.338 Build date: 2017-02-06 20:16:13 (3b7e83bcaafa58d3c831dca8fefc60af87b50271)
...
Ext.Base = (function(flexSetter) {
    ...
    Ext.apply(Base, {
        ...
        mixin: function(name, mixinClass) {
            var me = this,
                mixin, prototype, key, statics, i, ln, mixinName, mixinValue, mixins, mixinStatics;
            if (typeof name !== 'string') {
                mixins = name;
        ...
        Manager = Ext.apply(new Ext.Inventory(), {
            ...
            createOverride: function(className, data, createdFn) {
                var me = this,
                    ...
                    uses = data.uses,
                    mixins = data.mixins,
                    mixinsIsArray, depedenciesLoaded,
                    classReady = function() {
