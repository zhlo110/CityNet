			...
			combostore.load({
				callback: function (records, operation, success) {
					...
					if (Ext.isEmpty(records[0].data.taskid)) {
						Ext.MessageBox.alert("提示信息", "没有项目，无法创建报警列");
						return;
					}
						...
						items: [
							{
								...
								columns: [
									...
									{ header: '监控项名', minWidth: 1, width: 160, sortable: false, menuDisabled: true, draggable: false, dataIndex: 'schname' },
									{
										header: '标识颜色',
